    ...
    <Timeline style={{}} className="container mx-auto  w-10/12 my-24">
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Body>
            ...
            بتطوير منصتنا للمقالات الالكترونية والاخبار  المتخصصة في المنتجات والأجهزة
            التعليمية.
          </Timeline.Body>
        </Timeline.Content>
      </Timeline.Item>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Body>
            ...
            للمقالات الالكترونية والاخبار  بدقة، مضمونين تجربة مستخدم سلسة وتنقلًا سهلًا.
          </Timeline.Body>
        </Timeline.Content>
      </Timeline.Item>
      ...
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Timeline.Body>
            في مايو ٢٠٢٤، قمنا بإطلاق منصتنا للمقالات الالكترونية والاخبار  للجمهور، مما
